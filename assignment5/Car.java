...
public class Car extends Sprite{
	...
	//Car constructor
	Car(String overall_descrip, int capacity, Engine reference, String carImage){
	...
	public String getDescription(){
		...
		String full_car_descr = car_descr + " (engine: " + my_Engine.getDescription() +"), fuel: " + String.format("%.2f", getFuelLevel()) + "/" + my_GasTank.getCapacity() + " location: (" + getX() + "," + getY() + ")";
